...
from scripts.data.common import validate_catalog, write_json
...
OUT_JSON = Path("src/resources/data/sphere-items.json")
IMG_DIR = Path("src/resources/images/sphere")
