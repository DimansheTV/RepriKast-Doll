...
from scripts.data.common import WikiClient, abs_url, validate_catalog, write_json


OUT_JSON = Path("src/resources/data/trophy-items.json")
IMG_DIR = Path("src/resources/images/trophies")
